...
set PC98HDD=
set PC-98HXT=
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%"') do (
if /I "%%~xa"==".nhd" SET PC98HDD=%%~a
if /I "%%~xa"==".thd" SET PC98HDD=%%~a
if /I "%%~xa"==".hdi" SET PC98HDD=%%~a
)
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk10*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 10*"') do (
if /I "%%~xa"==".d88" SET PC98DSK10=%%~a
if /I "%%~xa"==".d98" SET PC98DSK10=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK10=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK10=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_10*"') do (
if /I "%%~xa"==".d88" SET PC98DSK10=%%~a
if /I "%%~xa"==".d98" SET PC98DSK10=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK10=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK10=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 11*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk11*"') do (
if /I "%%~xa"==".d88" SET PC98DSK11=%%~a
if /I "%%~xa"==".d98" SET PC98DSK11=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK11=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK11=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_11*"') do (
if /I "%%~xa"==".d88" SET PC98DSK11=%%~a
if /I "%%~xa"==".d98" SET PC98DSK11=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK11=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK11=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk12*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 12*"') do (
if /I "%%~xa"==".d88" SET PC98DSK12=%%~a
if /I "%%~xa"==".d98" SET PC98DSK12=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK12=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK12=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_12*"') do (
if /I "%%~xa"==".d88" SET PC98DSK12=%%~a
if /I "%%~xa"==".d98" SET PC98DSK12=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK12=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK12=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk13*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 13*"') do (
if /I "%%~xa"==".d88" SET PC98DSK13=%%~a
if /I "%%~xa"==".d98" SET PC98DSK13=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK13=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK13=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_13*"') do (
if /I "%%~xa"==".d88" SET PC98DSK13=%%~a
if /I "%%~xa"==".d98" SET PC98DSK13=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK13=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK13=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 14*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk14*"') do (
if /I "%%~xa"==".d88" SET PC98DSK14=%%~a
if /I "%%~xa"==".d98" SET PC98DSK14=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK14=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK14=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_14*"') do (
if /I "%%~xa"==".d88" SET PC98DSK14=%%~a
if /I "%%~xa"==".d98" SET PC98DSK14=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK14=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK14=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk15*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 15*"') do (
if /I "%%~xa"==".d88" SET PC98DSK15=%%~a
if /I "%%~xa"==".d98" SET PC98DSK15=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK15=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK15=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_15*"') do (
if /I "%%~xa"==".d88" SET PC98DSK15=%%~a
if /I "%%~xa"==".d98" SET PC98DSK15=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK15=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK15=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 1*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk1*"') do (
if /I "%%~xa"==".d88" SET PC98DSK1%%~a
if /I "%%~xa"==".d98" SET PC98DSK1%%~a
if /I "%%~xa"==".xdf" SET PC98DSK1%%~a
if /I "%%~xa"==".hdm" SET PC98DSK1%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 01*"') do (
if /I "%%~xa"==".d88" SET PC98DSK1%%~a
if /I "%%~xa"==".d98" SET PC98DSK1%%~a
if /I "%%~xa"==".xdf" SET PC98DSK1%%~a
if /I "%%~xa"==".hdm" SET PC98DSK1%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_1*"') do (
if /I "%%~xa"==".d88" SET PC98DSK1%%~a
if /I "%%~xa"==".d98" SET PC98DSK1%%~a
if /I "%%~xa"==".xdf" SET PC98DSK1%%~a
if /I "%%~xa"==".hdm" SET PC98DSK1%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk2*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 02*"') do (
if /I "%%~xa"==".d88" SET PC98DSK2=%%~a
if /I "%%~xa"==".d98" SET PC98DSK2=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK2=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK2=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk02*"') do (
if /I "%%~xa"==".d88" SET PC98DSK2=%%~a
if /I "%%~xa"==".d98" SET PC98DSK2=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK2=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK2=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 2*"') do (
if /I "%%~xa"==".d88" SET PC98DSK2=%%~a
if /I "%%~xa"==".d98" SET PC98DSK2=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK2=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK2=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_2*"') do (
if /I "%%~xa"==".d88" SET PC98DSK2=%%~a
if /I "%%~xa"==".d98" SET PC98DSK2=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK2=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK2=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 3*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk3*"') do (
if /I "%%~xa"==".d88" SET PC98DSK3=%%~a
if /I "%%~xa"==".d98" SET PC98DSK3=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK3=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK3=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_3*"') do (
if /I "%%~xa"==".d88" SET PC98DSK3=%%~a
if /I "%%~xa"==".d98" SET PC98DSK3=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK3=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK3=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk4*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 4*"') do (
if /I "%%~xa"==".d88" SET PC98DSK4=%%~a
if /I "%%~xa"==".d98" SET PC98DSK4=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK4=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK4=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_4*"') do (
if /I "%%~xa"==".d88" SET PC98DSK4=%%~a
if /I "%%~xa"==".d98" SET PC98DSK4=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK4=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK4=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 5*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk5*"') do (
if /I "%%~xa"==".d88" SET PC98DSK5=%%~a
if /I "%%~xa"==".d98" SET PC98DSK5=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK5=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK5=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_5*"') do (
if /I "%%~xa"==".d88" SET PC98DSK5=%%~a
if /I "%%~xa"==".d98" SET PC98DSK5=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK5=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK5=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk6*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 6*"') do (
if /I "%%~xa"==".d88" SET PC98DSK6=%%~a
if /I "%%~xa"==".d98" SET PC98DSK6=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK6=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK6=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_6*"') do (
if /I "%%~xa"==".d88" SET PC98DSK6=%%~a
if /I "%%~xa"==".d98" SET PC98DSK6=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK6=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK6=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 7*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk7*"') do (
if /I "%%~xa"==".d88" SET PC98DSK7=%%~a
if /I "%%~xa"==".d98" SET PC98DSK7=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK7=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK7=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_7*"') do (
if /I "%%~xa"==".d88" SET PC98DSK7=%%~a
if /I "%%~xa"==".d98" SET PC98DSK7=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK7=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK7=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk8*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 8*"') do (
if /I "%%~xa"==".d88" SET PC98DSK8=%%~a
if /I "%%~xa"==".d98" SET PC98DSK8=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK8=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK8=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_8*"') do (
if /I "%%~xa"==".d88" SET PC98DSK8=%%~a
if /I "%%~xa"==".d98" SET PC98DSK8=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK8=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK8=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk 9*"') do (
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk9*"') do (
if /I "%%~xa"==".d88" SET PC98DSK9=%%~a
if /I "%%~xa"==".d98" SET PC98DSK9=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK9=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK9=%%~a
...
for /f "tokens=* delims= " %%a in ('dir /b /a-d "%GBG%\%GAM%\%CONS%\%PC98%\%CSTM%\*Disk_9*"') do (
if /I "%%~xa"==".d88" SET PC98DSK9=%%~a
if /I "%%~xa"==".d98" SET PC98DSK9=%%~a
if /I "%%~xa"==".xdf" SET PC98DSK9=%%~a
if /I "%%~xa"==".hdm" SET PC98DSK9=%%~a
