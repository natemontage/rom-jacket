...
if /I "%CEMU%"=="UME" call :injecting
if /I "%CEMU%"=="Mess" call :injecting
if /I "%CEMU%"=="UME64" call :injecting
if /I "%CEMU%"=="Mess64" call :injecting
:extinjEND
